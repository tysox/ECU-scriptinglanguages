...
#
#Copies the secretPassword var into a file within the folderName dictated.
#The >> ensures that if there is a file already there, it's added to and not overwritten.
